...
for metric, display, thresholds, team_thresholds in (
    ("shots", "shots", (16.5, 18.5, 20.5), (7.5, 8.5, 9.5)),
    ("shots_on_target", "shots on target", (4.5, 5.5, 6.5), (1.5, 2.5, 3.5)),
    ...
    for side in ("home", "away"):
        for threshold in team_thresholds: LABELS[f"{side}_{metric}_over_{threshold}"] = f"{side.title()} team over {threshold} {display}"
